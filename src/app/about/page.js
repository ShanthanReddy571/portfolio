...
const HIGHLIGHTS = [
  "Cut sync latency ~40% across 100k+ devices with MQTT real‑time updates (Bosch).",
  "Achieved 92% alignment accuracy and −40% stitching latency for panoramic imaging (Samsung).",
  "~60% faster course site loads via front‑end redesign and smarter assets (UB).",
];
  ...
  return (
    ...
    >
      ...
      <div className="hero-wrap">
        ...
        {/* Quick CTAs (resume removed as requested) */}
      ...
      {/* Primary grid: bio + values */}
      <div className="mt-8 grid gap-6 sm:grid-cols-2">
        <div>
          <p className="opacity-90">
            I’m a CS Master’s graduate from the University at Buffalo (’25). Previously at Bosch and Samsung, I worked across React/React Native, Node, and CV pipelines.
          </p>
            ...
            {VALUES.map((v) => (
              <div key={v.title} className="card relative overflow-hidden p-4">
                ...
                <div className="relative flex items-start gap-3">
                  <div className="icon-btn h-9 w-9">
        ...
        <div className="card p-6">
          ...
          <ul className="mt-2 space-y-2 text-sm">
            <li>
              ...
              <div className="opacity-80">University at Buffalo · 2024–2025</div>
            </li>
            <li>
              <div className="font-medium">BTech in Computer Science</div>
              <div className="opacity-80">Amrita Vishwa Vidyapeetham · 2019–2023</div>
            </li>
          </ul>
        </div>
        <div className="card p-6">
